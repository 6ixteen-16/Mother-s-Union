...
const PLACEHOLDERS: Record<OrgContentSection, string> = {
  about:
    "[ABOUT US PLACEHOLDER] Mothers Union Buganda is the Buganda dioceses chapter of the worldwide Mothers Union, supporting women, children, and families through prayer, advocacy, and practical outreach.",
  vision:
    "[VISION PLACEHOLDER] A community where every woman, child, and family flourishes in faith, dignity, and love.",
  mission:
    "[MISSION PLACEHOLDER] To nurture strong Christian family life through prayer, advocacy, and hands-on community outreach across the Buganda dioceses.",
