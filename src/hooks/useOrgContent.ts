...
const DEFAULT_CORE_VALUES = [
  ...
  { title: "Unity & Fellowship", body: "The Association fosters unity, love, and sisterhood among all members across all six Buganda diocesess, and maintains fellowship with Mothers' Union members beyond Buganda." },
...
const PLACEHOLDER_CONTENT: Record<OrgContentSection, string> = {
  about:
    "Mothers' Union Buganda Association is the Buganda dioceses chapter of the worldwide Mothers' Union, a Christian charity dedicated to advancing the Christian religion in the sphere of marriage and family life. We unite Christian women in prayer, worship, and service — supporting marriages, nurturing families, and building Christ-centred communities through fellowship, education, counselling, and development projects across all six Buganda diocesess.",
  vision:
    "To advance the Christian religion in the sphere of marriage and family life, fostering stable, God-centred families and communities across all Buganda diocesess.",
  mission:
